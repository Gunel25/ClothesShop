    ...
    public partial class ass : Migration
    {
        ...
        migrationBuilder.CreateTable(
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Ürünümüz unisex olduğundan kadın ve erkek için uygundur.", "slideshow-character1.png", true, "Oversize Bisiklet Yaka Pamuk Baskılı Kısa Kollu Tişört" },
                    { 2, "Modelin Ölçüleri: Boy: 1.70, Göğüs: 87, Bel: 65, Kalça: 93, Beden:S/34/1 Stüdyo çekimlerinde renkler ışık farklılığından dolayı değişiklik gösterebilir.\r\n", "slideshow-character2.png", true, "Kadın Dik Yaka Uzun Kollu Bluz" }
                });
