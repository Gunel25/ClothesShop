...
namespace ClothesShop.Extensions
{
...
//////            //var mailFrom = new MailboxAddress("Admin", "cabbarligunel0899@gmail.com");
//////            //var mailTo = new MailboxAddress("User", to);

//////            var mimeMessage = new MimeMessage();
//////            mimeMessage.From.Add(new MailboxAddress("Gunel", "cabbarligunel0899@gmail.com"));
//////            mimeMessage.To.Add(MailboxAddress.Parse(to));
//////            mimeMessage.Subject = "subject";
...
//////            await client.AuthenticateAsync("cabbarligunel0899@gmail.com", "whix vuul kupc gfpp");
//////            await client.SendAsync(mimeMessage);
//////            await client.DisconnectAsync(true);
//////            var msg = new MimeMessage();
//////            var mailFrom = new MailboxAddress("Admin", "cabbarligunel0899@gmail.com");
